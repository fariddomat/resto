<x-app-layout>
    <div class="container mx-auto p-6">
        ...
        <h1 class="text-2xl font-bold mb-4">
            @lang('site.create') @lang('site.purchaseitems')
        </h1>
        ...
        <form action="{{ route('dashboard.purchase_items.store') }}" method="POST" class="bg-white p-6 rounded-lg shadow-md">
            @csrf
            ...
            <div class="mb-4">
                ...
                <input type="number" name="price" value="{{ old('price') }}" class="w-full border border-gray-300 rounded p-2" step="0.01">
                @error('price')
                    <span class="text-red-500 text-sm">{{ $message }}</span>
                @enderror
            </div>
            ...
            <div class="mb-4">
                ...
                <select name="purchase_category_id" class="w-full border border-gray-300 rounded p-2">
                    <option value="">@lang('site.purchasecategories')</option>
